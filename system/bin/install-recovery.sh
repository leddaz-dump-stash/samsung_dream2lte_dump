#!/system/bin/sh
if ! applypatch -c EMMC:/dev/block/platform/11120000.ufs/by-name/RECOVERY:43583776:c186be898dc1aafe0841918addfe2eb61112146e; then
  applypatch EMMC:/dev/block/platform/11120000.ufs/by-name/BOOT:37155104:b7e92463c875992fa27e977ebef1f60a7c160a87 EMMC:/dev/block/platform/11120000.ufs/by-name/RECOVERY c186be898dc1aafe0841918addfe2eb61112146e 43583776 b7e92463c875992fa27e977ebef1f60a7c160a87:/system/recovery-from-boot.p && log -t recovery "Installing new recovery image: succeeded" || echo 454 > /cache/fota/fota.status
else
